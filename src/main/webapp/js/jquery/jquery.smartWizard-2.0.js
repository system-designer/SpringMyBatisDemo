define(function(require, exports, module) {
	...
	//seajs.use(window.baseUrl||''+ '/css/smart_wizard.css');
	seajs.use(window.baseUrl||''+ '/css/smart_wizard_vertical.css');
        ...
        return this.each(function(){
                ...
                if (!action || action === 'init' || typeof action === 'object') {
                  ...
                  return true;
                	...
                	var ar = Array.prototype.slice.call( args, 1 );
                	return showStep(ar[0]);
                }else if(action === 'updateSize'){
                	var ar = Array.prototype.slice.call( args, 1 );
                	return updateSize(ar[0]);
                } else {
                ...
                function updateSize(stepIdx){
                    var selStep = steps.eq(stepIdx); 
                	obj.find('.stepContainer').height($($(selStep, obj).attr("href"), obj).outerHeight());	
                }
